      ...
      <AppBar color="inherit">
        <Toolbar sx={{ display: "flex", justifyContent: "space-between",
         ...
         {/* <NavLink to="shop" style={{ textDecoration: "none" }}><Typography sx={{ fontFamily: 'Quicksand', fontWeight: 'bold', color: '#3a2f25', cursor: 'pointer', fontSize: { xs: '0.5rem', sm: '1rem'} }}>SHOP</Typography></NavLink> */} 
          <NavLink to="/contacts" style={{ textDecoration: "none" }}><Typography sx={{ fontFamily: 'Quicksand', fontWeight: 'bold', color: '#3a2f25', cursor: 'pointer', fontSize: { xs: '0.5rem', sm: '1rem'} }}>CONTACTS</Typography></NavLink>
        </Toolbar>
      </AppBar>
    </Box>
  );
